...
# === Configuration ===
INPUT_FILE = "base_questions/sample_3.json" # adjust accordingly
OUTPUT_DIR = "RESPONSE_dynamic_questions"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SAMPLE_3_generated_dynamic_questions.json")  # adjust accordingly

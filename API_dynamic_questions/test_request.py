...
# === Configuration ===
INPUT_FILE = "base_questions/sample_2.json" # adjust accordingly
OUTPUT_DIR = "RESPONSE_dynamic_questions"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "NEW_SAMPLE_2_generated_dynamic_questions.json")  # adjust accordingly
